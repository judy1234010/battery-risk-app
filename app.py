...
# =========================================================
    ...
    st.info("""
이 메뉴는 특정 체인에서 위험점수가 급등한 시점과 그 원인을 추적하는 화면입니다.

활용 방법
1) 전월 대비 최종위험점수 변화폭이 큰 월을 찾습니다.
2) 해당 시점에 가격·수급·물류·정책 중 어떤 축이 상대적으로 높았는지 확인합니다.
3) 급등 월을 중심으로 원인 축을 파악해 대응 우선순위를 정합니다.
""")
